...
public class Restcontroller {
	...
	public String saveEmployee(@RequestParam String username, @RequestParam String fullname, @RequestParam String address, @RequestParam double salary, @RequestParam String password) {
